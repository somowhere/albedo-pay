...
public class Order extends DataEntity {
	...
	/** tradeId 第三方交易编号 */@NotBlank @Length(max=128)@Column(name = "trade_id")
	...
	/** clientIp client_ip */@Length(max=32)@Column(name = "client_ip")
	...
	/** finishTime 订单完成时间 */@Column(name = "finish_time")
	private Date finishTime;
	/** openId open_id */@Length(max=128)@Column(name = "open_id")
	private String openId;
	/** attach 附加参数 */@Length(max=255)@Column(name = "attach_")

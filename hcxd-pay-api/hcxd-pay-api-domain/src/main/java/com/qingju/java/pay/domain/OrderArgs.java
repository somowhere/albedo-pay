...
public class OrderArgs extends DataEntity {
	...
	private String id;
	/** name 名称 */@NotBlank @Length(max=64)@Column(name = "name_")
	private String name;
	/** argsType 参数类型 */@NotNull @Column(name = "args_type")@DictType(name="pay_args")
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderArgs == false) return false;

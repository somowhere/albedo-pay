...
public class Alipay extends BaseTrade {
	...
	private void sign(Map<String, Object> param, boolean withQoute) {
		sign = buildRequestMysign(param, ConstantPay.TRADE_TYPE_ALIPAY, ConstantPay.ALIPAY_KEY_PRI, withQoute);
	...
	// PayWechatParam.ALIPAY_REWARD_NOTIFY_URL);
	...
	// params.put("sign", buildRequestMysign(params,
	// ConstantPay.TRADE_TYPE_ALIPAY, payAlipayParam.getKeyPri(), true));

package com.albedo.java.common.pay.core.vo;

import java.util.HashMap;
import java.util.LinkedHashMap;
import java.util.Map;

import com.albedo.java.common.pay.http.HttpRequest;
...
import com.albedo.java.common.pay.exception.AssertHandler;
import com.albedo.java.common.pay.http.HttpResultType;
...
public class Wechat extends BaseTrade {
	...
	public String getOpenId(String code, int userType) {
		...
		String authReq = "appid=" + appId + "&secret=" + secret + "&code=" + code + "&grant_type=authorization_code";
	...
	public String getTOpenId(String code) {
		String authReq = "appid=" + payWechatParam.getPayTappId() + "&secret=" + payWechatParam.getPayTappSecret()
	...
	public String reward(String tradeNo, String openId, String userName, String amount, int userType) {
		...
		String result = sslXmlPost(payWechatParam.getPayTransfersApi(), certFile, mch_id, xml);
		return result;
	}

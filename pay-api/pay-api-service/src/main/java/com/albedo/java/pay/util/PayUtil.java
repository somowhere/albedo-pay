package com.albedo.java.pay.util;
...
import com.albedo.java.common.pay.ConstantDictPay;
import com.albedo.java.common.pay.ConstantPay;
import com.albedo.java.pay.domain.OrderArgs;
import com.albedo.java.pay.service.OrderArgsService;
...
public class PayUtil {
	...
	private static final String KEY_PAY_PREFIX = "arg-";
		...
		try {
			...
			if (PublicUtil.isNotEmpty(dictList)) {
				...
				String codeConstant = ConstantPay.TRADE_TYPE_ALIPAY == payType
						? ConstantDictPay.PAY_DCIT_CONSTANT_APLIPAY
						: ConstantPay.TRADE_TYPE_WEIXIN == payType ? ConstantDictPay.PAY_DCIT_CONSTANT_WECHAT : null;
	...
	public static String genPayCode() {
		return PublicUtil.toAppendStr(PublicUtil.getCurrentTime("yyMMddHHmmsssss"), PublicUtil.getRandomNumber(6));
	}

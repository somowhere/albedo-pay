...
public class Alipay extends BaseTrade {
    ...
    private String partner = ConstantPay.ALIPAY_PARTNER;
    ...
    private String seller_id = ConstantPay.ALIPAY_SELLER_ID;

    //未付款交易的超时时间
    private String it_b_pay = ConstantPay.ALIPAY_PAY_TIME_OUT;

    //提现接口
    private String reward_service = ConstantPay.ALIPAY_REWARD_SERVICE_API;

    //账户名字
    private String account_name = ConstantPay.ALIPAY_ACCOUNT_NAME;
    ...
    public boolean notifyVerify (String notifyId) {
        ...
        map.put("service", ConstantPay.ALIPAY_VERYFY_SERVICE_API);
        map.put("partner", partner);
        this.request.setUrl(ConstantPay.ALIPAY_GATEWAY);
    ...
    public String buildRequestPara(){
        String notifyUrl = notify_url + ConstantPay.ALIPAY_NOTIFY_URL;
    ...
    public void buildRewardParam(Map<String, Object> params){
        ...
        params.put("notify_url", notify_url + ConstantPay.ALIPAY_REWARD_NOTIFY_URL);
        ...
        params.put("sign", buildRequestMysign(params, ConstantPay.TRADE_TYPE_ALIPAY, ConstantPay.ALIPAY_KEY_PRI, true));
    ...
    public Map<String, Object> payValidate(String payCode){
        ...
        map.put("partner", partner);
        map.put("service", ConstantPay.ALIPAY_QUERY_SERVICE_API);
        sign(map, true);
